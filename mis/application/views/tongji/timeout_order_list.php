...
<script type="text/javascript"> 
    ...
    <?php if (!empty($list)):?>
        <?php foreach ($list as $key => $item): ?>
            <script type="text/javascript"> 
                ...
                value_array.push(<?php echo $item['item_3'];?>);        
            </script> 
        <?php endforeach;?>
    ...
    {         
        window.location.replace("http://"+window.location.host+"/mis/index.php?c=tongji&m=get_timeout_order_list&startdate="+time1+"&enddate="+time2);
