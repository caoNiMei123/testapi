...
#carpool create 
curl 'http://127.0.0.1:8089/rest/2.0/carpool/order?method=create&devuid=1&ctype=1' -d 'type=2' -d 'src=abcd' -d 'src_gps=39.970207,116.418088' -d 'dest=efgh' -d 'dest_gps=39.970207,116.418088' -d 'user_name=18601165873' -d 'user_type=2' -d 'user_id=10045' -d 'mileage=100'
#carpool cancel
...
#carpool nearby
curl 'http://127.0.0.1:8089/rest/2.0/carpool/order?method=nearby&devuid=1&ctype=1' -d 'user_name=18601165874' -d 'user_type=1' -d 'user_id=10010' -d 'gps=39.970207,116.418088' 
#user report
...
#image upload
curl 'http://127.0.0.1:8089/rest/2.0/carpool/file?method=upload&devuid=1&ctype=1&user_name=18601165872&user_type=1&user_id=10001&type=1' -F  'filename=@./a.jpg'    
